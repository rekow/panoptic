(function () {/*
 David Rekow 2014
*/
function e(a,b,c){var d;b&&(c=c||"",Object.defineProperty(this,"_root",{value:b}),Object.defineProperty(this,"_path",{value:c}));this._prop={};this._cb={};for(d in a)a.hasOwnProperty(d)&&"function"!==typeof a[d]&&this.bind(d,a[d])}
...
constructor:e,bind:function(a,b){Object.defineProperty(this,a,{enumerable:!0,get:function(){return this._prop[a]},set:function(b){this._prop[a]=b;l(this,a,b,this)}});this.set(a,b)}};function l(a,b,c,d){if(a._root)return l(a._root,a._path+"."+b,c,d);(a=a._cb[b])&&a.forEach(function(a){a.call(d,c)})}
function k(a,b,c){b=b.split(".");var d=b.pop(),f=a._path||"",n=a._root||a,g,h;for(h=0;h<b.length;h++){g=b[h];f+="."+g;if(!a.hasOwnProperty(g)){if(void 0===c||null===c)return null;a.bind(g,new e(null,n,f))}a=a[g]}f+=f?"."+d:d;if(void 0===c)return a[d];a.hasOwnProperty(d)||a.bind(d);if("object"===typeof c){if(a[d]instanceof e)return a[d].set(c);c instanceof e||c instanceof Array||(c=new e(c,n,f))}a[d]=c}function m(a){return new e(a)}
