...
function h(a,b,c){b=b.split(".");var d=b.pop(),f=a._path||"",m=a._root||a,g,k;for(k=0;k<b.length;k++){g=b[k];f+=f?"."+g:g;if(!a[g]){if(void 0===c||null===c)return null;a.hasOwnProperty(g)?a[g]=new e(null,m,f):a.bind(g,new e(null,m,f))}a=a[g]}f+=f?"."+d:d;if(void 0===c)return a[d];a.hasOwnProperty(d)||a.bind(d);if("object"===typeof c){if(a[d]instanceof e)return a[d].set(c);c instanceof e||c instanceof Array||(c=new e(c,m,f))}a[d]=c}
